...
public class DataProviderUtils {
	...
	public static Iterator<CreateJobPayload> CreateJobAPIDataProvider() {
		...
		Iterator<CreateJobBean> bean = CSVReaderUtil.loadCSV("testData" + File.separator + "CreateJobData.csv",
				CreateJobBean.class);
	...
	public static Iterator<CreateJobPayload> CreateJobAPIExcelDataProvider() {
		...
		Iterator<CreateJobBean> bean = ExcelReaderUtil.loadTestData("CreateJobTestData", CreateJobBean.class);
	...
	public static Iterator<CreateJobPayload> CreateJobAPIDataBaseDataProvider() {
		...
		Iterator<CreateJobBean> bean = CreateJobPayloadDataDao.getCreateJobPayLoadData();
